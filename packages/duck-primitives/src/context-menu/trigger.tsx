...
const ContextMenuTrigger = React.forwardRef<ContextMenuTriggerElement, IContextMenu.ITriggerProps>(
  (props: IContextMenu.IScoped<IContextMenu.ITriggerProps>, forwardedRef) => {
