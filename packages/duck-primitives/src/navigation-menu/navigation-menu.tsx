...
import { DismissableLayer } from '~/new-primitives/dismissable-layer'
import { useCallbackRef } from '~/new-primitives/hooks/use-callback-ref'
import { useControllableState } from '~/new-primitives/hooks/use-controllable-state'
import { useDirection } from '~/new-primitives/hooks/use-direction'
import { useId } from '~/new-primitives/hooks/use-id'
import { useLayoutEffect } from '~/new-primitives/hooks/use-layout-effect'
import { usePrevious } from '~/new-primitives/hooks/use-previous'
import { composeEventHandlers } from '~/new-primitives/libs/compose-event-handler'
import { composeRefs, useComposedRefs } from '~/new-primitives/libs/compose-ref'
import { createCollection } from '~/new-primitives/libs/create-collection'
import type { Scope } from '~/new-primitives/libs/create-context'
import { createContextScope } from '~/new-primitives/libs/create-context'
import { Presence } from '~/new-primitives/presence'
import { dispatchDiscreteCustomEvent, Primitive } from '~/new-primitives/primitive-elements'
import * as VisuallyHiddenPrimitive from '~/new-primitives/visibility-hidden'
...
const NavigationMenuList = React.forwardRef<NavigationMenuListElement, NavigationMenuListProps>(
  (props: ScopedProps<NavigationMenuListProps>, forwardedRef) => {
    ...
    const list = <Primitive.ul data-orientation={context.orientation} {...listProps} ref={forwardedRef} />
