...
const perComponent = [
  ...
  { name: 'Context Menu', gentleduck: gdSizes['context-menu'] ?? 0, radix: 0 },
  { name: 'Dialog', gentleduck: gdSizes.dialog ?? 0, radix: 10830 },
  { name: 'Dropdown Menu', gentleduck: gdSizes['dropdown-menu'] ?? 0, radix: 0 },
  { name: 'Hover Card', gentleduck: gdSizes['hover-card'] ?? 0, radix: 0 },
  { name: 'Menubar', gentleduck: gdSizes.menubar ?? 0, radix: 0 },
  { name: 'Nav Menu', gentleduck: gdSizes['navigation-menu'] ?? 0, radix: 0 },
  { name: 'Popover', gentleduck: gdSizes.popover ?? 0, radix: 20073 },
  { name: 'Progress', gentleduck: gdSizes.progress ?? 0, radix: 0 },
  { name: 'Radio Group', gentleduck: gdSizes['radio-group'] ?? 0, radix: 1066 },
  { name: 'Select', gentleduck: gdSizes.select ?? 0, radix: 24251 },
  { name: 'Slider', gentleduck: gdSizes.slider ?? 0, radix: 0 },
  { name: 'Toggle', gentleduck: gdSizes.toggle ?? 0, radix: 1707 },
  { name: 'Toggle Group', gentleduck: gdSizes['toggle-group'] ?? 0, radix: 0 },
