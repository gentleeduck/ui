...
const menuItems = {
  markdown: (url: string) => (
    <a className={MENU_ITEM_CLASS} href={`${url}.md`} rel="noopener noreferrer" target="_blank">
      <svg aria-hidden="true" className={MENU_ITEM_ICON_CLASS} strokeLinejoin="round" viewBox="0 0 22 16">
        <path
          clipRule="evenodd"
  ...
  v0: (url: string, siteName: string) => (
    <a className={MENU_ITEM_CLASS} href={getPromptUrl('https://v0.dev', url, siteName)} rel="noopener noreferrer" target="_blank">
      <svg
        aria-hidden="true"
  ...
  chatgpt: (url: string, siteName: string) => (
    <a className={MENU_ITEM_CLASS} href={getPromptUrl('https://chatgpt.com', url, siteName)} rel="noopener noreferrer" target="_blank">
      <svg aria-hidden="true" className={MENU_ITEM_ICON_CLASS} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path
  ...
  claude: (url: string, siteName: string) => (
    <a className={MENU_ITEM_CLASS} href={getPromptUrl('https://claude.ai/new', url, siteName)} rel="noopener noreferrer" target="_blank">
      <svg aria-hidden="true" className={MENU_ITEM_ICON_CLASS} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path
  ...
  scira: (url: string, siteName: string) => (
    <a
      className={MENU_ITEM_CLASS}
      href={getPromptUrl('https://scira.ai/', url, siteName)}
