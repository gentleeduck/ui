...
import type { DateRange, SelectionConstraints } from './selection.types'
 ...
 */
export function isInRange<TDate>(adapter: DateAdapter<TDate>, date: TDate, range: DateRange<TDate>): boolean {
