...
export default function Demo() {
  return (
    <div>
      ...
      <MotionTypographyP index={3}>The king thought long and hard, and finally came up with a brilliant plan.</MotionTypographyP>
      ...
      <MotionTypographyP index={6}>The king's subjects were not amused. They grumbled and complained, but the king was firm:</MotionTypographyP>
