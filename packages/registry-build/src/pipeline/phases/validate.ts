...
import type { RegistryBuildSource, RegistryItemType } from '../../types'
...
export async function runValidatePhase(context: RegistryBuildContext): Promise<RegistryBuildPhaseResult> {
  ...
  for (const [type, source] of Object.entries(context.config.sources) as Array<[RegistryItemType, RegistryBuildSource]>) {
