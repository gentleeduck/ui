              ...
              <Collapsible className="group/collapsible" defaultOpen={index === 1} key={item.title}>
                <SidebarMenuItem>
                  <CollapsibleTrigger asChild>
                    <SidebarMenuButton>
                      {item.title}{' '}
                      <Plus aria-hidden="true" className="ml-auto group-data-[open=true]/collapsible:hidden" />
                      <Minus aria-hidden="true" className="ml-auto group-data-[open=false]/collapsible:hidden" />
                    </SidebarMenuButton>
                  </CollapsibleTrigger>
                  {item.items?.length ? (
                    <CollapsibleContent>
