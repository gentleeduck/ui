...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html
              ...
              (function() {
                try {
                  ...
                  var applyPresetStyles = function () {
                    document.documentElement.setAttribute('data-font-preset', preset);
                    document.documentElement.style.setProperty('--acme-font-family', family);
                  ...
                  document.documentElement.style.setProperty('--acme-font-style', style);
                } catch (e) {}
              })();
            `,
          }}
      ...
      <body className={cn('acme min-h-svh bg-background antialiased')}>
