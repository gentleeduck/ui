...
function SidebarProvider({
  ...
  // openProp/setOpenProp drive controlled mode; internalOpen is the uncontrolled fallback.
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Persist across reloads via a cookie so SSR can pick the right initial state.
  ...
  // Expose state as a string so Tailwind data-state= selectors can target it.
