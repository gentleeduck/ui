...
Production mode is ~2x faster than development on simple checks. The gap widens for batch operations because the per-check Decision allocation cost compounds.
