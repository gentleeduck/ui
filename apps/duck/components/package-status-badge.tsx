...
export function PackageStatusBadge({ status, className }: { status: PackageLifecycleStatus; className?: string }) {
  ...
  return (
    <Badge
      ...
      className={cn(
        'w-fit rounded-full px-2.5 py-0.5 font-semibold text-[0.65rem] uppercase tracking-[0.18em]',
        className,
      )}
