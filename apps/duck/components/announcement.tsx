...
export function Announcement() {
  return (
    <Link
      href="/www/changelog/get-started"
      ...
      <span className="hidden truncate sm:inline">gentleduck/ui — Charts, Sidebar blocks, and more</span>
      <span className="truncate sm:hidden">Charts &amp; Sidebar blocks</span>
      <span className="hidden shrink-0 underline sm:inline">See what's new</span>
