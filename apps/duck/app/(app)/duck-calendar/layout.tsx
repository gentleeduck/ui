...
export const metadata: Metadata = {
  ...
  description: 'Headless calendar engine with date adapters — zero dependencies, multi-calendar support, and full TypeScript types.',
  keywords: [
...
export default function DuckCalendarLayout({ children }: { children: React.ReactNode }) {
  const config = getPackageDocsConfig('duck-calendar')
