    ...
    <div className="relative space-y-20">
      <div>
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto max-w-lg text-base text-muted-foreground leading-relaxed">
            Duck Gen reads your server code and emits typed route and message modules. No duplicate OpenAPI schemas. No
            drift between client and production endpoints.
          </p>
        </div>
      ...
      <div>
        <div className="mb-8 flex flex-col items-center gap-1 text-center">
          ...
          <p className="text-muted-foreground text-sm">Works with NestJS today. Express and Fastify support is next.</p>
        </div>
