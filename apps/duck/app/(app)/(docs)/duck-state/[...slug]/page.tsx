...
import { duckStateSidebar } from '~/config/sidebars'
import { absoluteUrl } from '~/lib'
import { duckState } from '../../../../../.gentleduck'
export const dynamic = 'force-static'
export const dynamicParams = false
export const revalidate = false

const PKG_PREFIX = 'duck-state'
const sidebar = duckStateSidebar
  ...
  return (
    <div className="container flex-1 items-start md:grid md:grid-cols-[270px_minmax(0,1fr)] md:gap-6 lg:grid-cols-[300px_minmax(0,1fr)] lg:gap-10">
      <aside
        ...
        <nav aria-label="Duck State sections" className="h-full overflow-y-auto overflow-x-hidden pb-8 pt-10">
          <DocsSidebarNav config={sidebar} />
        </nav>
      </aside>
      <main className="relative py-6 pr-4 lg:gap-10 lg:py-8 xl:grid xl:grid-cols-[1fr_300px]" id="top">
        <article className="relative mx-auto w-full min-w-0 max-w-2xl mt-20">
