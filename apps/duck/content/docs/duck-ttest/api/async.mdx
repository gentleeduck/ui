---
title: async
description: Function, promise, and iterable helpers for async-shaped types.
section: API
order: 3
---
...
Recursively unwrap nested `PromiseLike`s. Same behavior as TypeScript's built-in `Awaited`.
