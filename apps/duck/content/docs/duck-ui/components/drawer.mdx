...
<ComponentPreview name="drawer-8" description="A drawer with an active trigger style when open." />

### Sides

Open the drawer from the `top`, `right`, `bottom`, or `left` by setting the `direction` prop.

<ComponentPreview name="drawer-9" description="A drawer that opens from each of the four sides." />
...
<ComponentPreview name="drawer-10" description="A right-side drawer with scrollable content." />
