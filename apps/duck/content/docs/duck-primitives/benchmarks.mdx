...
**Radio Group** is one case where Radix is smaller (1.0 KB vs 1.9 KB). Not every primitive is smaller.
...
A smaller bundle is not always better. gentleduck ships more behavior per component than minimal alternatives:
...
2. **Omits the behavior**. Base UI and Headless UI skip compound components, roving focus, and presence animations. You write that code.
