...
<div className="mt-6 grid gap-4 sm:grid-cols-2 sm:gap-6">
  <LinkedCard href="https://gentleduck.org/docs" target="_blank" rel="noopener noreferrer">
  ...
  <LinkedCard href="https://gentleduck.org/www/components/button" target="_blank" rel="noopener noreferrer">
    <div className="flex flex-col p-4">
