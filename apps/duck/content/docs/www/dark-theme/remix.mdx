...
<Step>Configure your CSS file</Step>

Make sure your CSS file includes the dark mode custom variant. This allows you to use the `dark` class on your html element to apply dark theme styles.
...
```tsx {1-5,8-13,17-24,27-28,30,35} title="app/root.tsx" showLineNumbers
