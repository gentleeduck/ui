...
See [CLI docs](/duck-cli) for command examples.
...
See the full [primitives docs](/duck-primitives) for API reference and guides.
...
See the full [chart docs](/duck-ui/components/chart) for all chart types and examples.
...
- Full docs at [/duck-ui/components/json-editor](/duck-ui/components/json-editor) with installation, usage, examples, and API reference
...
All core packages now have structured docs with architecture diagrams, philosophy sections, and API overviews. See the [Core Packages](/duck-cli) sidebar section.
