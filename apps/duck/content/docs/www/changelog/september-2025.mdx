...
- Added [CLI docs](/duck-cli) with init, add, and template commands
- Added resizable component docs
- Added package docs for [duck-lazy](/duck-lazy), [duck-variants](/duck-variants), and [duck-vim](/duck-vim)
