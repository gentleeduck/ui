...
- [Installation](/docs/installation) — pick a framework and bring gentleduck into your app.
- [Packages](/docs/packages) — what each package does and how it fits with the rest.
- [Comparisons](/docs/comparisons) — bundle sizes, feature matrices, and migration guides versus Radix, shadcn, and react-day-picker.
- [FAQs](/docs/faqs) — short answers to the questions we hear most often.
