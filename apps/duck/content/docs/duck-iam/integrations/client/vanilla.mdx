---
title: vanilla js
description: Framework-agnostic AccessClient with subscribe, merge, fromServer, and helpers for any JS runtime. Foundation for Svelte, Solid, and custom integrations.
