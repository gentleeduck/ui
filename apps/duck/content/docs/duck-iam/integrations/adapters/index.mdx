...
description: Storage layer for duck-iam — pick a built-in adapter (Memory, Prisma, Drizzle, Redis, HTTP) or implement the Adapter interface for custom backends.
