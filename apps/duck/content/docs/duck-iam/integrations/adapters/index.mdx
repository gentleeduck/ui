...
description: Storage layer for duck-iam - pick a built-in adapter (Memory, File, Prisma, Drizzle, Redis, HTTP) or implement Adapter.IAdapter for custom backends.
section: Integrations
---
## What is an adapter?

Adapters are duck-iam's storage layer. They implement `Adapter.IAdapter`, which combines three stores:
