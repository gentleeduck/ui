...
|
+- No
|  +- Need persistence between runs? -> FileAdapter
|  +- Otherwise                      -> MemoryAdapter
|
+- Yes
   |
   +- CLI / single-process daemon? -> FileAdapter
   ...
   +- Custom backend?               -> Implement Adapter.IAdapter (see "Custom" doc)
```
...
<Accordion type="multiple" collapsible className="w-full">
  ...
  <AccordionItem value="httphandler-surface">
    ...
    <AccordionContent className="text-muted-foreground">
      ...
      HttpAdapter also expects subject-attribute reads (<code>/subjects/:id/attributes</code>) and scoped-role reads
