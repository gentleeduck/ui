...
| `definePolicy(id)` | `PolicyBuilder<TAction, TResource, TRole, TScope>` | Create a policy with typed rules and role checks |
...
| `createEngine(config)` | `IamEngine<TAction, TResource, TRole, TScope>` | Create a typed engine instance |
...
<Accordion type="multiple" collapsible className="w-full">
  ...
  <AccordionItem value="c8-migrate">
    <AccordionTrigger>How do I migrate from IamMemoryAdapter to a database?</AccordionTrigger>
    <AccordionContent className="text-muted-foreground">
  ...
  <AccordionItem value="c8-http-adapter-auth">
    <AccordionTrigger>How do I authenticate the IamHttpAdapter?</AccordionTrigger>
    <AccordionContent className="text-muted-foreground">
