...
description: defineIam() - lock down actions, resources, scopes, roles, and conditions at the type level. Compile-time validation for the whole permission schema.
section: Advanced
---
