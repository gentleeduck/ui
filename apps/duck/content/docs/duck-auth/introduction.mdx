...
<MermaidDiagram chart={`flowchart TB
    ...
    subgraph Root["AuthEngine"]
        direction TB
        ROOT["AuthEngine config"]
...
- [Core concepts ->](/duck-auth/core) - read about `AuthEngine`, facets, and the request lifecycle.
