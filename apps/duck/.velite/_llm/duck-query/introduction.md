...
See [Using without Duck Gen](/duck-query/advanced#using-without-duck-gen).
...
See [Client Methods](/duck-query/client-methods) for detailed documentation of each method.
...
| --- | --- |
| [Client Methods](/duck-query/client-methods) | Detailed docs for every client method with examples. |
| [Types](/duck-query/types) | All exported types and how to use them for custom route maps. |
| [Advanced](/duck-query/advanced) | Interceptors, custom Axios instances, using without Duck Gen, and patterns. |
| [Templates](/duck-query/advanced) | Complete NestJS + Duck Query example project. |