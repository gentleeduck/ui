...
- [Getting Started](/docs/packages/duck-registry-build/getting-started) - Install and ship your first build.
- [Architecture](/docs/packages/duck-registry-build/architecture) - Build lifecycle, context, artifacts, and extension stages.
- [Configuration](/docs/packages/duck-registry-build/configuration) - Full config reference.
- [Extensions](/docs/packages/duck-registry-build/extensions) - Built-in extensions and the custom extension API.
- [CLI](/docs/packages/duck-registry-build/cli) - Commands, flags, JSON output, scripting patterns.
- [Performance](/docs/packages/duck-registry-build/performance) - Cache behavior, changed-only mode, warm builds.
- [Recipes](/docs/packages/duck-registry-build/recipes) - Patterns for docs sites, manifests, and custom outputs.
- [Course](/docs/packages/duck-registry-build/course) - Walkthrough for building an Arch-style package index.
- [Testing and CI](/docs/packages/duck-registry-build/testing-ci) - Golden tests, pack smoke tests, release checks.
- [Troubleshooting](/docs/packages/duck-registry-build/troubleshooting) - Failure modes and debugging paths.
