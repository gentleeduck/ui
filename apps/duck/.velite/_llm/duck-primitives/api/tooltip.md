...
| Prop | Type | Default | Description |
| --- | --- | --- | --- |
| `disableCloseOnClick` | `boolean` | `false` | When `true`, clicking the trigger does not dismiss the tooltip. Use when wrapping interactive elements like `Toggle` with `asChild`. |
