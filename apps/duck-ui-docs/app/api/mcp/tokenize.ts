...
const STOP_WORDS = new Set([
  ...
  'is', 'it', 'as', 'be', 'was', 'are', 'were', 'been', 'being', 'have', 'has', 'had', 'do', 'does',
  'did', 'will', 'would', 'could', 'should', 'may', 'might', 'can', 'shall', 'not', 'no', 'nor', 'so',
  'if', 'then', 'than', 'that', 'this', 'these', 'those', 'each', 'every', 'all', 'any', 'few', 'more',
  'most', 'other', 'some', 'such', 'only', 'own', 'same', 'too', 'very', 'just', 'about', 'above',
  'after', 'again', 'also', 'am', 'because', 'before', 'between', 'both', 'during', 'he', 'her', 'here',
  'him', 'his', 'how', 'i', 'into', 'its', 'me', 'my', 'now', 'our', 'out', 'she', 'them', 'there',
  'they', 'up', 'us', 'we', 'what', 'when', 'where', 'which', 'who', 'why', 'you', 'your',
])
