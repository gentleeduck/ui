...
<ComponentPreview name="chart-benchmark-primitives-vs" description="gentleduck vs Radix" className="[<ComponentPreview name="chart-benchmark-primitives" description="Primitives benchmark dashboard" />_[data-value='preview']>div:last-child]:h-130" />
