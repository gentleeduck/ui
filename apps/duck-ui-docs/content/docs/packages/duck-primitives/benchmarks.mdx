...
<ComponentPreview name="chart-benchmark-size" description="Bundle size comparison: gentleduck vs Radix UI" />
...
<ComponentPreview name="chart-benchmark-savings" description="Size savings vs Radix UI per component" />

---

## Total Package Size

<ComponentPreview name="chart-benchmark-total" description="Total package size vs component count across libraries" />
