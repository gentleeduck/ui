...
<ComponentPreview name="chart-benchmark-primitives-vs" description="gentleduck vs Radix verified comparisons" className="[&_[data-value='preview']>div:last-child]:h-130" />
...
<ComponentPreview name="chart-benchmark-primitives-all" description="All 29 components compared" className="[&_[data-value='preview']>div:last-child]:h-210" />

---

## Module Sizes + Total

<ComponentPreview name="chart-benchmark-primitives" description="Module breakdown and library totals" className="[&_[data-value='preview']>div:last-child]:h-110" />
