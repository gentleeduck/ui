...
gentleduck primitives are 50-92% smaller than their Radix equivalents because shared internals (Slot, Presence, Popper, focus-scope) are deduplicated across all primitives.

<ComponentPreview name="chart-benchmark-primitives" description="Module breakdown and totals" className="[<ComponentPreview name="chart-benchmark-primitives" description="Primitives benchmark dashboard" />_[data-value='preview']>div:last-child]:h-110" />
