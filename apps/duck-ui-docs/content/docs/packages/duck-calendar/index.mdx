...
![Bundle Size Comparison](/images/benchmarks/calendar/bundle-size.svg)

![Feature Comparison](/images/benchmarks/calendar/features.svg)

7 KB gzipped. Zero dependencies. Full keyboard navigation. Complete ARIA compliance. See the [full benchmarks](/docs/packages/duck-calendar/course/08-performance).
...
- **7 KB gzipped** -- 2-6x smaller than every alternative
