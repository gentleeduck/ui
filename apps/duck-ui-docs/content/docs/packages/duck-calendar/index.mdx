...
<ComponentPreview name="chart-benchmark-calendar-vs" description="Calendar vs other libraries" className="[&_.preview]:min-h-[420px]" />

<ComponentPreview name="chart-benchmark-calendar-compare" description="Per-library comparison tables" className="[&_.preview]:min-h-[500px]" />

<ComponentPreview name="chart-benchmark-calendar" description="Calendar internals" className="[&_.preview]:min-h-[420px]" />

~5 KB gzipped. Zero dependencies. Full keyboard navigation. Complete ARIA compliance. See the [full benchmarks](/docs/packages/duck-calendar/course/08-performance).
