...
graph LR
  A["Calendar Engine"] --> B["DateAdapter&lt;TDate&gt;"]
...
| `DateFnsAdapter` | `@gentleduck/calendar/adapters/date-fns` | Adapter for date-fns | `date-fns` |
| `DayjsAdapter` | `@gentleduck/calendar/adapters/dayjs` | Adapter for dayjs | `dayjs` |
| `LuxonAdapter` | `@gentleduck/calendar/adapters/luxon` | Adapter for Luxon | `luxon` |
| `PersianAdapter` | `@gentleduck/calendar/adapters/persian` | Persian / Jalali calendar | None |
| `IslamicAdapter` | `@gentleduck/calendar/adapters/islamic` | Islamic / Hijri calendar | None |
| `HebrewAdapter` | `@gentleduck/calendar/adapters/hebrew` | Hebrew calendar | None |
...
| `getDayOfWeek` | `(d) => WeekStartDay` | Day of week (0=Sun) |
