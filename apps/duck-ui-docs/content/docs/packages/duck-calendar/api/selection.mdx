...
```tsx
selectDay(adapter: DateAdapter<TDate>, mode: SelectionMode, current: CalendarValue<TDate, M>, date: TDate) => CalendarValue<TDate, M>
```

| Param | Type | Description |
| :--- | :--- | :--- |
| `adapter` | `DateAdapter<TDate>` | Date adapter |
| `mode` | `SelectionMode` | `'single'`, `'range'`, or `'multi'` |
...
| `value` | `CalendarValue<TDate, M>` | Current selection |
