...
<Step>Extensions ran in order</Step>

In this example only the custom extension runs. For a UI registry build, use `uiRegistryPreset()` to include the standard index-build, components, colors, and component-index extensions.
