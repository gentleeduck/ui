...
This page focuses on patterns that come up in real consumers, not just field-by-field reference material.
...
## Recipe 2: Custom manifest extension
...
## Recipe 3: External static data files
...
## Recipe 5: Custom framework component index
...
## Recipe 6: Fast local rebuild loop
