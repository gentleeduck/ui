...
| `...props` | `React.ComponentPropsWithoutRef<typeof DialogPrimitive.Root>` | -- | Additional props inherited from `Dialog.Root`. |
...
| `...props` | `Omit<DialogPrimitive.Trigger, 'size' \| 'asChild'> & Omit<Button, 'asChild'>` | -- | Additional props inherited from `Omit<Dialog.Trigger, 'size' \| 'asChild'> & Omit<Button, 'asChild'>`. |
...
| `...props` | `React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content>` | -- | Additional props inherited from `Dialog.Content`. |
...
| `...props` | `React.ComponentPropsWithoutRef<typeof DialogPrimitive.Heading>` | -- | Additional props inherited from `Dialog.Heading`. |
...
| `...props` | `React.ComponentPropsWithoutRef<typeof DialogPrimitive.Title>` | -- | Additional props inherited from `Dialog.Title`. |
...
| `...props` | `React.ComponentPropsWithoutRef<typeof DialogPrimitive.Description>` | -- | Additional props inherited from `Dialog.Description`. |
