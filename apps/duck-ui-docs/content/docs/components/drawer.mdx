...
*Also accepts all `DrawerPrimitive.Trigger` props.*

### DrawerPortal

Wrapper around `DrawerPrimitive.Portal`. Renders drawer content in a React Portal.

*Accepts all `DrawerPrimitive.Portal` props.*
...
*Also accepts all `DrawerPrimitive.Close` props.*
...
*Also accepts all `DrawerPrimitive.Overlay` props.*
...
*Also accepts all `DrawerPrimitive.Title` props.*
...
*Also accepts all `DrawerPrimitive.Description` props.*
