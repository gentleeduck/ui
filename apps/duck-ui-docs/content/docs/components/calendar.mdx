...
*Also accepts all standard `React.ComponentProps<typeof DayPicker>` props.*
...
| `className` | `string` | -- | Additional class names for styling the day button |

*Also accepts all standard `React.ComponentProps<typeof DayButton>` props.*
