...
*Also accepts all `react-resizable-panels` `PanelGroup` props (e.g. `autoSaveId`, `onLayout`).*
...
*Also accepts all `react-resizable-panels` `Panel` props.*
...
*Also accepts all `react-resizable-panels` `PanelResizeHandle` props.*
