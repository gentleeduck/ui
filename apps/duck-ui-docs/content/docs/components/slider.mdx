...
| `dir` | `'ltr' \| 'rtl'` | -- | Reading direction. Resolved at the primitive layer via `useDirection` and inherited by all sub-components through context. |
...
| `orientation` | `'horizontal' \| 'vertical'` | `'horizontal'` | Slider orientation |
| `dir` | `'ltr' \| 'rtl'` | -- | Reading direction for horizontal sliders |
