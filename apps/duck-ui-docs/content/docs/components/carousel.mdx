...
Carousels are controversial -- done wrong, they hide content behind interaction. We wrap Embla Carousel because it handles the hard parts (touch gestures, snap points, accessibility, RTL support) without opinions about visual design. Our layer adds the duck-ui styling and exposes Previous/Next controls as composable elements.
