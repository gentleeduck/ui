...
### Animated Popover (Motion)

Use `MotionPopoverContent` for smooth enter/exit animations with a bouncy spring. The transform origin matches the placement side automatically.
