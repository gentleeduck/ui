...
```text
┌─────────────────────────────────────────────────┐
│  1. Read duck-gen.json config                   │
│  2. Build TypeScript project from tsconfigPath  │
│  3. Scan controllers + @duckgen message sources │
│  4. Extract routes, request/response types      │
│  5. Emit .d.ts files                            │
└─────────────────────────────────────────────────┘
```
